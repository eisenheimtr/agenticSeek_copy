...
# Static file directory for screenshots
if not os.path.exists(".screenshots"):
    os.makedirs(".screenshots")
app.mount("/screenshots", StaticFiles(directory=".screenshots"), name="screenshots")

# Initialize system (provider, agents, browser, interaction)
...
async def process_query(request: QueryRequest):
    ...
    if is_generating:
        ...
        return JSONResponse(status_code=429, content=query_resp.model_dump())
    ...
    try:
        ...
        if not success:
            ...
            return JSONResponse(status_code=400, content=query_resp.model_dump())
        ...
        return JSONResponse(status_code=200, content=query_resp.model_dump())
    except Exception as e:
